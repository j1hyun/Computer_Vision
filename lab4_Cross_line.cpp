...
void DrawRectOutline(BYTE * Img, int W,  int LU_X, int LU_Y, int RD_X, int RD_Y)
{
...
int main()
{
	...
	}//과제 예제에 동공 주변이 흰색이 아니라 검은색이어서 다시 검은색으로 처리하였습니다.
	cenx = sumx / cnt;
	ceny = sumy / cnt;
	DrawRectOutline(Output, W,  xmin, ymin, xmax, ymax);
	...
	SaveBMPFile(hf, hInfo, hRGB, Output, hInfo.biWidth, hInfo.biHeight, "output_bin_edge1.bmp");
